...
class SignUpView extends StatefulWidget {
  const SignUpView({Key? key, this.showLicenceNoField = false})
      : super(key: key);
            ...
            child: Form(
              ...
              child: ListView(
                children: [
                  ...
                  const SizedBox(height: 20),
                  if (widget.showLicenceNoField)
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 15),
                      child: SocTextField(
                        labelText: "Licence No*",
                        validator: model.validateLicenseNo,
                        placeholder: "qwerty1234",
                        errorText: model.licenseNoError,
                        onChanged: (value) => model.licenseNo = value!,
                      ),
                    ),
                  const SizedBox(
                    height: 50,
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          ...
                          decoration:
                              const BoxDecoration(color: MyTheme.lightGrey)),
                      const Padding(
